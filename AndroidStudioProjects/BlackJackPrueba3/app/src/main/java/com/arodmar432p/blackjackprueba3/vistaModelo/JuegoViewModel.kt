...
import com.arodmar432p.blackjackprueba3.modelo.Baraja
...
class JuegoViewModel(application: Application) : AndroidViewModel(application) {
    private val recursos = application.resources
    private val recursosBocaAbajo = application.resources
    ...
    val turnoActual: LiveData<Jugador> get() = _turnoActual // Para exponer turnoActual como una propiedad pública
